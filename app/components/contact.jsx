      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <div className="mb-3 flex justify-center">
            <span className="section-eyebrow">CONTACT // 聯絡我們</span>
          </div>
          <h2 className="section-title text-3xl lg:text-4xl font-bold mb-4">
            聯絡我們
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
          {/* SCIST 聯絡方式 */}
          <div>
            <h3 className="text-3xl font-bold mb-6 text-center lg:text-center">
              SCIST
            </h3>
